"""Snapshot and verify tracked frozen Stage 2C--2D.4 scientific assets."""
...
if __name__=="__main__":
    ...
    p.add_argument("--manifest",type=Path);p.add_argument("--out",type=Path,required=True)
    main(p.parse_args())
